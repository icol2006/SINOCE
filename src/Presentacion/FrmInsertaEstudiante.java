 ...
 * @author Maykol
 */
public class FrmInsertaEstudiante extends javax.swing.JFrame {

    /**
     * Creates new form FrmInsertaEstudiante
     */
    public FrmInsertaEstudiante() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingresar Estudiantes nuevo ");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (txtCedula.getText().isEmpty() || txtCarnet.getText().isEmpty() || txtNombre.getText().isEmpty() || txtApellido1.getText().isEmpty() || txtApellido2.getText().isEmpty()) {
            ...
            int resultado = estudianteData.insertar(personaData.getIdPersona(),carnet);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmInsertaEstudiante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmInsertaEstudiante().setVisible(true);
            }
        });
    }
