...
public class FrmActualizarProfesor extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrmActualizarProfesor
     */
                ...
                .addGroup(layout.createSequentialGroup()
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addComponent(txtProfesion, javax.swing.GroupLayout.PREFERRED_SIZE, 259, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(txtEspecialidad, javax.swing.GroupLayout.PREFERRED_SIZE, 373, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (txtCedula.getText().isEmpty() || txtNombre.getText().isEmpty() || txtApellido1.getText().isEmpty()
                || txtApellido2.getText().isEmpty() || txtEspecialidad.getText().isEmpty() || txtProfesion.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Para continuar, complete todos los campos solicitados");
        } else {
            int horas = 0, cod = 0;
            Persona personaData = new Persona();
            Profesor profesorData = new Profesor();
            ...
            int resultado1 = personaData.actualizar(idPersona, cedPersona, nombre, apellido1, apellido2, correoPersonal);
            int resultado2 = profesorData.actualizar(this.idProfesor, especialidad, profesion, this.idPersona);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (respuesta != Constantes.EXITO) {
            ...
            this.idProfesor = datos.getIdProfesor();
            this.txtEspecialidad.setText(datos.getEspecialidadProfesor());
            this.txtProfesion.setText(datos.getProfesionProfesor());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmActualizarProfesor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmActualizarProfesor().setVisible(true);
            }
        });
    }
