...
public class FrmListadoEstudiantes extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrmListadoEstudiantes
     */
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CarneEstudiante", "Cedula", "Nombre", "Apellido 1", "Apellido 2", "Email"
            }
        ) {
    ...
    private void refrescarTabla() {
        ...
        ArrayList<Estudiante> listado = data.ListarTodo();
        agregarDatosJTable(listado);
    }

    public void agregarDatosJTable(ArrayList<Estudiante> list) {
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        model.setRowCount(0);

        Object rowData[] = new Object[6];
        for (int i = 0; i < list.size(); i++) {
            rowData[0] = list.get(i).getCarneEstudiante();
            rowData[1] = list.get(i).getCedulaPersona();
            rowData[2] = list.get(i).getNombrePersona();
            rowData[3] = list.get(i).getApellido1();
            rowData[4] = list.get(i).getApellido2();
            rowData[5] = list.get(i).getCorreoElectronico();
