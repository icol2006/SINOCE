...
public class FrmInsertarProfesor extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrmInsertarProfesor
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Insertar Profesor ");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (txtCedula.getText().isEmpty() || txtNombre.getText().isEmpty() || txtApellido1.getText().isEmpty()
            ...
            personaData.insertar(cedPersona, nombre, apellido1, apellido2, correoPersonal);

            personaData.buscarPorCedula(cedPersona);

            int resultado = profesorData.insertar(especialidad, profesion, personaData.getIdPersona(), cedPersona);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmInsertarProfesor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmInsertarProfesor().setVisible(true);
            }
        });
    }
